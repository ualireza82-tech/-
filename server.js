 ...
 * 
 * ⚠️ IMPORTANT: 
 * - فقط بخش ۷.۵ (Block System) اصلاح شده
...
app.get('/api/health', async (req, res) => {
  try {
    ...
    res.json({
      ...
      server: 'AJ Sports 2026 Backend v2.1.0'
    });
  } catch (error) {
...
// ======================================================
// 4. AUTH & USER MANAGEMENT - بدون تغییر
// ======================================================
...
app.post('/api/auth/check-account', async (req, res) => {
  try {
    ...
    const result = await pool.query(
      "SELECT id, username, display_name, avatar_url, verification, bio, is_admin FROM users WHERE email = $1",
      [email]
    );
...
// ======================================================
// 7.5 🚀 BLOCK SYSTEM - نسخه نهایی اصلاح‌شده - تضمین ۱۰۰٪
// ======================================================
...
// ======================================================
// 14. SERVER START - بدون تغییر
// ======================================================

const PORT = process.env.PORT || 3000;
server.listen(PORT, () => {
  console.log('\n' + '='.repeat(60));
  console.log('🚀 AJ Sports 2026 Backend v2.1.0');
