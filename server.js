...
class RSSNewsSystem {
    ...
    this.NEWS_ACCOUNTS = [
      {
        ...
        avatar: 'https://i.postimg.cc/dtZTBd3N/england-premier-league-logo-on-transparent-background-free-vector.jpg',
      ...
      },
      {
        ...
        avatar: 'https://i.postimg.cc/RFvcp0yM/25051101001498-Org.jpg',
      ...
      },
      {
        ...
        display_name: 'لالیگا 🇪🇸',
        avatar: 'https://i.postimg.cc/s2h6C1TW/la-liga-announcement-1-720x540-c-default.png',
      ...
      },
      {
        ...
        avatar: 'https://i.postimg.cc/NG5DrdhP/Serie-A-logo-2022-svg.png',
      ...
      },
      {
        ...
        avatar: 'https://i.postimg.cc/wMnvRfds/champions-league-logo-symbol-white-design-football-european-countries-football-teams-illustration-wi.jpg',
      ...
      },
      {
        ...
        avatar: 'https://i.postimg.cc/8zHMYvQW/1763812086906.jpg',
  ...
  start() {
    ...
    this.checkInterval = setInterval(() => this.checkAllFeeds(), 20 * 1000);
