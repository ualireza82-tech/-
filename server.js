 ...
 * 
 * ✅ FIXES v2.4.0:
 * - اضافه شده: /api/auth/verify-otp برای صحت‌سنجی کد
 * - اضافه شده: /api/upload/image برای آپلود امن عکس
 * - اضافه شده: cloudinary و multer برای آپلود
 * - رفع مشکل: عدم بررسی کد OTP
 * - رفع مشکل: آپلود مستقیم از فرانت‌اند
 * - بهبود امنیت: همه درخواست‌ها از بک‌اند می‌گذرند
 */
...
app.get('/api/health', async (req, res) => {
  try {
    ...
    res.json({
      ...
      server: 'AJ Sports 2026 Backend v2.4.0'
    });
  } catch (error) {
...
// ======================================================
// 4. ✅ NEW: UPLOAD SYSTEM - آپلود امن عکس
// ======================================================
...
// آپلود با base64 (برای عکس‌های گرفته شده با دوربین)
...
// ======================================================
// 11. ADMIN MANAGEMENT - بدون تغییر
// ======================================================
...
// ======================================================
// 13. ADMIN TWEET DELETE - بدون تغییر
// ======================================================
...
// ======================================================
// 14. LIVE MATCHES & ROOMS - بدون تغییر
// ======================================================
...
app.use((req, res) => {
  ...
  res.status(404).json({ 
    ...
    available_endpoints: {
      ...
      upload_base64: 'POST /api/upload/base64',
      // Users
...
server.listen(PORT, () => {
  console.log('\n' + '='.repeat(60));
  console.log('🚀 AJ Sports 2026 Backend v2.4.0');
  ...
  console.log('\n🆕 NEW FEATURES v2.4.0:');
  console.log('  • Upload System    ✅ (Secure upload via backend)');
  console.log('  • Verify OTP       ✅ (Code validation fixed)');
