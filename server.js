 ...
 * 
 * ⚠️ IMPORTANT: 
 * - فقط بخش نوتیفیکیشن به کد اضافه شده
 * - سایر بخش‌ها دقیقاً مثل نسخه v2.6.3 هستند
 * - اضافه شدن ۳ API جدید برای نوتیفیکیشن
...
app.get('/api/health', async (req, res) => {
  try {
    ...
    res.json({
      ...
      server: 'AJ Sports 2026 Backend v2.6.4'
    });
  } catch (error) {
...
// ======================================================
// 14. ✅ NEW: NOTIFICATIONS SYSTEM - اضافه شده
// ======================================================
...
// دریافت تعداد نوتیفیکیشن‌های نخوانده
...
server.listen(PORT, () => {
  console.log('\n' + '='.repeat(60));
  console.log('🚀 AJ Sports 2026 Backend v2.6.4');
  ...
  console.log('\n🆕 NEW IN v2.6.4:');
  console.log('  • Get Notifications    ✅ /api/notifications/:username');
  console.log('  • Unread Count         ✅ /api/notifications/:username/unread-count');
  console.log('  • Mark as Read         ✅ /api/notifications/:username/mark-read');
