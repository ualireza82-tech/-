 ...
 * - 🆕 سیستم نشست‌های فعال (سشن‌ها)
 * - 🆕 تشخیص کشور کاربر از روی IP
 * - 🆕 غیرفعال‌سازی حساب با OTP و حذف خودکار بعد ۳۰ روز
 * - 🆕 مرکز حریم خصوصی و تنظیمات حساب
 */
...
const cron = require('node-cron'); // ✅ برای حذف خودکار حساب‌ها
...
// ✅ NEW: Send OTP via Supabase (اضافه شده با تضمین عدم تداخل)
...
// ======================================================
// 10. 🚀 BLOCK SYSTEM - ✅ اصلاح شده - تضمین ۱۰۰٪
// ======================================================
...
// ======================================================
// 11. ADMIN TWEET DELETE - بدون تغییر
// ======================================================
...
// ======================================================
// 12. LIVE MATCHES & ROOMS - بدون تغییر
// ======================================================
...
// ======================================================
// 13. 🆕 NEW: ACCOUNT SETTINGS & SESSIONS - v2.3.0
// ======================================================
// ✅ کاملاً ایزوله - بدون کوچکترین تداخل با مسیرهای قبلی
// ======================================================

// [SET-01] ثبت و به‌روزرسانی کشور کاربر
...
// [SET-02] دریافت اطلاعات حساب کاربری
...
// [SET-03] دریافت تمام نشست‌های فعال کاربر
...
// [SET-06] خروج از تمام نشست‌ها به جز نشست جاری
...
// [SET-07] ارسال OTP برای تأیید حذف حساب
...
// [SET-08] تأیید OTP و غیرفعال‌سازی حساب
...
// [SET-09] لغو درخواست غیرفعال‌سازی
...
// [SET-10] بررسی وضعیت درخواست غیرفعال‌سازی
...
// ======================================================
// 14. ⏰ CRON JOB FOR AUTO DELETE EXPIRED ACCOUNTS
// ======================================================
...
// ======================================================
// 16. GLOBAL ERROR HANDLER - بدون تغییر
// ======================================================
...
// ======================================================
// 17. 404 HANDLER - ✅ اصلاح شده برای نمایش new features
// ======================================================
...
app.use((req, res) => {
  ...
  res.status(404).json({ 
    ...
    available_endpoints: {
      ...
      auth_send_otp: 'POST /api/auth/send-otp', // ✅ اضافه شد
...
// ======================================================
// 18. SERVER START - ✅ اصلاح شده برای نمایش v2.3.0
// ======================================================
...
server.listen(PORT, () => {
  ...
  console.log('  • Send OTP         ✅ (اضافه شد)'); // ✅ اضافه شد
  console.log('='.repeat(60) + '\n');
});

// ======================================================
// 19. GRACEFUL SHUTDOWN - بدون تغییر
// ======================================================
