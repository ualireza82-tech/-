 ...
 * PRO SERVER v2.5.0 - با پشتیبانی کامل از هشتگ
 * 
 * ⚠️ IMPORTANT: 
 * - فقط بخش هشتگ اضافه شده
...
async function fetchLinkMetadata(url) {
    try {
        ...
        // استفاده از fetch ساده - در بک‌اند مشکل CORS نداریم
        const response = await fetch(fullUrl, {
            headers: {
                'User-Agent': 'Mozilla/5.0 (compatible; AJSportsBot/1.0)'
            },
            timeout: 5000
        });
        ...
        return null; // برگردوندن null به جای آبجکت خالی
    }
}
...
server.listen(PORT, () => {
  ...
  console.log('  • Stories         ✅');
  console.log('  • Tweets          ✅');
  console.log('  • Hashtag System   ✅ (جدید)');
